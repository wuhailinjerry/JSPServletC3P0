...
<div class="container-fluid ">
    <form action="<%=path%>/add.do" method="post">
        <table class="table table-hover table-bordered">
            <tr>
                <td colspan="2" style="font-size: 16px; font-weight: bold; text-align: center;">添加会员</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="user_id"/><span class="spmsg"></span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="user_birthday" onclick="WdatePicker()"/></td>
            </tr>
            <tr>
            <td align="right" style="vertical-align: middle;">手机号码：</td>
            <td><input type="text" name="user_telephone"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="color:red;font-size:20px;" align="center">${msg }</td>
            </tr>
        </table>
    </form>
</div>
...
<script type="text/javascript" src="resource/scripts/add.js"></script>
</body>
</html>